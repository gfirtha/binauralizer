function draggable_autorotate(h,varargin)
...
r0 = -h.UserData.Origin/norm(h.UserData.Origin);
fi0 = cart2pol(r0(1),r0(2))*180/pi;

rot = fi0 - h.UserData.Orientation;
rotate(h,[0 0 1], rot*10,[h.UserData.Origin(1),h.UserData.Origin(2),0]);
