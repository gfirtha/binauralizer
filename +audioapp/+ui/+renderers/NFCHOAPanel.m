classdef NFCHOAPanel < audioapp.ui.renderers.RendererPanel
    properties
        EdtOrder
    end
    ...
    methods
        function build(obj, parent)
            ...
            uicontrol(obj.Root,'Style','text','String','NFCHOA Order:',...
    ...
    methods (Access=private)
        function onOrderChanged(obj, src)
            ...
            if ~isnan(v) && isfinite(v) && v>=0 && mod(v,1)==0
                obj.C.Setup.Renderer_setup.HOAorder = v;   % shared field
                obj.updateRenderer();
            else
